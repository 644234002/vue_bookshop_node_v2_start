                                   ...
                                   <Form @submit.prevent="submit"  class="row g-4">
                                           ...
                                           <div class="col-12">
                                               ...
                                               <div class="input-group">
                                                   ...
                                                   <!-- Modify Code : Add requried to validate email -->
                                                    <Field name="email" type="email"  v-model="email" :rules="validateEmail" class="form-control" placeholder="Enter e-mail"/>
                                                </div>
                                           ...
                                           <div class="col-12">
                                               ...
                                               <div class="input-group">
                                                   ...
                                                   <Field name="password" type="password" v-model="password" :rules="validatePassLen" class="form-control" placeholder="Enter Password"/>
                                               </div>
